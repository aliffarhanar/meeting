	...
	<div class="row" style="background-image:url('images/bg-putih.png');height: 135%;margin-bottom:100px;">
		<div class="col-sm-2 col-md-2 sidebar-offcanvas" style=" background-color: rgba(255, 255, 255, 0.5); height: 100%;padding-right: 0;" id="sidebar-wrapper" role="navigation">
			<ul class="nav nav-sidebar list-sidebar-menu">
				...
				?>
						<li class="<?=!isset($_GET['page'])||$_GET['page']=='manage-building'?'active':''?>"><a style="text-align: right; font-family: inherit;" href="?page=manage-building">Manage Building </a></li>
						<li class="<?=!isset($_GET['page'])||$_GET['page']=='manage-room'?'active':''?>"><a style="text-align: right; font-family: inherit;" href="?page=manage-room">Manage Room </a></li>
		...
		<div class="col-md-10">
			...
			switch($page) {
				...
				case "manage-building":$include = "find-building-admin.php";break;
